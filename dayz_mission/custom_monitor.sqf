...
while {true} do
{
	...
	<t size='1.15' font='Bitstream'align='center' color='#D60000'>NO PVP | PVE ONLY</t><br/>
	<t size='1.25' font='Bitstream'align='center' color='#5882FA'>Rainbow Dash's Super Awesome Fun Server</t><br/>
