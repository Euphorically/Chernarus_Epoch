...
if ((getPlayerUID player) in ["117938630","126019334","117883654","108405574","122391302","122396102","152713862"]) then { //all admins
	if ((getPlayerUID player) in ["152713862"]) then { //mods
        adminmenu =
        [
			["",true],
				["Tools Menu", [2], "#USER:ModToolsMenualesha", -5, [["expression", ""]], "1", "1"],
				...
				["Vehicle Menu", [5], "#USER:VehicleMenu", -5, [["expression", ""]], "1", "1"],				
				["", [-1], "", -5, [["expression", ""]], "1", "0"],
			["Exit", [13], "", -3, [["expression", ""]], "1", "1"]	
        ];};
	if ((getPlayerUID player) in ["122391302","108405574","122396102"]) then { //admins
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["117938630","126019334","117883654"]) then { // super admins
		adminmenu =
		[
			["",true],
