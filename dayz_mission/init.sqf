...
dayZ_instance =	2317;					//The instance
dayzHiveRequest = [];
initialized = false;
dayz_previousID = 0;
...
[] ExecVM "addmap\buildings.sqf";															// Extra Charnarus Buildings 1.2
//[] ExecVM "addmap\raceday.sqf";															    // Coastal Racetrack 1.1
//[] ExecVM "addmap\fightyard.sqf";															// Cherno Fightyard 1.0
...
///////////////////////////////////////////////////////////////////////////////////////////
// POI Chernarus - Locations

[] ExecVM "addmap\Dambase.sqf";                                                             // Damn Base Lol
//[] ExecVM "addmap\clanbasedavid.sqf";                                                       // Davids Base Crazy
//[] ExecVM "addmap\LieuxditPenduAto.sqf";													// Wreck Sites
//[] ExecVM "addmap\bolmclan.sqf";                                                            // BOLM Clan Base
[] ExecVM "addmap\dream.sqf";                                                               // Dream Home dock
[] ExecVM "addmap\meth.sqf";                                                                // Meth Home dock

// Upadtes and additons on these will be posted separate and included in furture updates.
///////////////////////////////////////////////////////////////////////////////////////////
